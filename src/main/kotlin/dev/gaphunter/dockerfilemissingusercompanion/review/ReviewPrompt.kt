package dev.gaphunter.dockerfilemissingusercompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.dockerfilemissingusercompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.dockerfilemissingusercompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Dockerfile Missing USER Instruction Companion"

    private const val MARKETPLACE_URL =
        "https://plugins.jetbrains.com/plugin/34003-dockerfile-missing-user-instruction-companion/reviews"
